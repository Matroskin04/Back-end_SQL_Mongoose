...
export class AddedAutoGeneratingPrimaryColumn1699338255565 implements MigrationInterface {
    name = 'AddedAutoGeneratingPrimaryColumn1699338255565'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "icon_of_blog" ADD "id" uuid NOT NULL DEFAULT uuid_generate_v4()`);
